...
public class UserBookingActivity extends AppCompatActivity {
    ...
    private EditText etPickupDate, etReturnDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carPrice = intent.getDoubleExtra("price", 0);
        carId = intent.getIntExtra("car_id", -1);

        btnSubmitBooking.setOnClickListener(v -> addNewRental());
    ...
    public void addNewRental() {
        Log.d("NewRentalActivity", "addNewBooking called");
