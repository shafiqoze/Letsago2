...
public class UserCarList extends AppCompatActivity implements CarAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvCarList = findViewById(R.id.rvUserCarList);
        ...
        carService.getAllCars(token).enqueue(new Callback<List<Car>>() {
            ...
            public void onResponse(Call<List<Car>> call, Response<List<Car>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    //initialize adapter
                    adapter = new CarAdapter(getApplicationContext(), cars, UserCarList.this);
    ...
    public void onItemClick(int position) {
        ...
        if (selectedCar != null) {
            Intent intent = new Intent(UserCarList.this,UserBookingActivity.class);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        inflater.inflate(R.menu.user_car_context_men, menu);
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.usercarmenu_details) {
